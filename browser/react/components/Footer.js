	        ...
	        <div className="row footer">
                  <div className="row flex center">
                        ...
                        {!this.props.options.playTour &&
                            <div className="nIcon flex center middle" value=""><span value="play" className="fa fa-play" onTouchTap={(e)=>this.animate(e)} onClick={(e)=>this.animate(e)} ></span></div>
                        }
                        {this.props.options.playTour &&
                            <div className="nIcon flex center middle" value=""><span value="pause" className="fa fa-pause" onTouchTap={(e)=>this.animate(e)} onClick={(e)=>this.animate(e)} ></span></div>
                        }
                        <p>(with zoom)</p>
                        {!this.props.options.playTour &&
                            <div className="nIcon flex center middle" value=""><span value="play" className="fa fa-play opacity25" onTouchTap={(e)=>this.animate(e, 'out')} onClick={(e)=>this.animate(e, 'out')} ></span></div>
                        }
                        {this.props.options.playTour &&
                            <div className="nIcon flex center middle" value=""><span value="pause" className="fa fa-pause opacity25" onTouchTap={(e)=>this.animate(e, 'out')} onClick={(e)=>this.animate(e, 'out')}></span></div>
                        }
