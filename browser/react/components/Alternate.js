		...
		return (
		    <MuiThemeProvider muiTheme={muiTheme} >
		        ...
		        <Nav />
			      ...
			      <div className="row">
			        <div id="container">
			        <h4 className="text-center" style={{margin: '20px'}}>Given the rich detail of Merlo's map, this application has been optimized for screens of resolution 1024px wide or larger <br/>(laptop & desktop viewing).</h4>
